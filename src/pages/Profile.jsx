    ...
    <div className="space-y-6 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-7 space-y-6">
          <div className="flex flex-col sm:flex-row items-center sm:items-start gap-4 bg-white p-4 rounded-2xl border border-gray-100 shadow-sm text-center sm:text-left">
