...
const Security = () => {
  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto pb-10">
      ...
      <div className="space-y-4">
        <h3 className="text-xl font-bold text-gray-900 flex items-center gap-2">
          <Shield className="w-5 h-5 text-yellow-500" /> Two-Factor
          Authentication
        </h3>
        <p className="text-gray-500 text-sm">
        ...
        <div className="flex items-center gap-3">
          <div
            className={`w-14 h-8 rounded-full p-1 cursor-pointer transition-colors ${
              is2FAEnabled ? "bg-blue-500" : "bg-gray-300"
            }`}
            onClick={() => setIs2FAEnabled(!is2FAEnabled)}
          >
            <div
              className={`bg-white w-6 h-6 rounded-full shadow-sm transition-transform ${
        ...
        <div
          className={`space-y-3 transition-opacity ${
            is2FAEnabled ? "opacity-100" : "opacity-50 pointer-events-none"
          }`}
        >
          {[
            {
            ...
            },
            {
              id: "email",
              label: "Email OTP",
              sub: "Receive codes via email",
              icon: Mail,
            },
            {
              id: "app",
              label: "Authenticator App",
              sub: "Google Auth / Microsoft Auth",
              icon: Lock,
            },
          ].map((method) => (
            <div
        ...
        <div className="flex gap-4 pt-2">
          <Button className="bg-brand-dark hover:bg-brand-navy">
            Setup 2FA
          </Button>
          <Button
            variant="outline"
      ...
      <div className="space-y-4">
        ...
        <div className="bg-gray-50 rounded-xl overflow-hidden">
          ...
          <div className="hidden md:grid md:grid-cols-4 p-4 bg-gray-200 text-sm font-bold text-gray-700">
            <div>Device</div>
            <div>Location</div>
            <div>Last Login</div>
              ...
              <div key={activity.id} className="p-4">
                ...
                <div className="md:hidden space-y-3">
                  ...
                  <div className="flex gap-4 text-sm text-gray-500">
                    ...
                    <span>•</span>
                    <span>{activity.lastLogin}</span>
                  </div>
                </div>
                {/* Desktop Layout */}
                <div className="hidden md:grid md:grid-cols-4 items-center text-sm">
        ...
        <div className="flex justify-center pt-4">
          <Button className="bg-brand-dark hover:bg-brand-navy w-48">
            Log Out All Device
          </Button>
        </div>
      </div>
